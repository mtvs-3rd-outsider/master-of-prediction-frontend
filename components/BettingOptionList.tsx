...
const BettingOptionList = () => {
  ...
  const option_data2 = {
    title: "바이든",
    imgSrc:
      "https://flexible.img.hani.co.kr/flexible/normal/800/533/imgdb/original/2024/0417/20240417503416.jpg",
    chartData: [
      {
        pv: 4000,
      },
  ...
  return (
    <>
      <ul role="list" className=" divide-y divide-gray-200">
        <BettingOption data={option_data1} />
