...
const BettingProduct = (props: BettingProductType) => {
  ...
  return (
    ...
    scroll-snap-type-x mandatory scroll-smooth"
            ...
            <ul className="mt-4 mb-4 px-4 flex justify-between gap-x-10 xl:gap-x-14 text-xs text-slate-700 [&_li:first-child]:hidden [&_li:first-child]:lg:flex [&_li]:flex [&_li]:items-center [&_li]:gap-x-2 [&_li:xl]:gap-x-3">
              {postStats && (
                <PostStatsNav
